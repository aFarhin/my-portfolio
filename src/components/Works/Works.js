...
const projectList = [
  ...
  },
  {
    name: 'WeatherApp',
    description:
      'The Weather App is a web-based application created with HTML, CSS, and JavaScript. It empowers users to search for the current weather conditions in a particular location. The app retrieves weather data from a weather API and presents crucial details like temperature, weather description, humidity, and wind speed. It boasts a responsive design to ensure compatibility with various devices. Users have the flexibility to customize the app\'s appearance by adjusting CSS styles and layout. This Weather App serves as a user-friendly tool for swiftly checking the weather in different locations.',
  ...
  },
  {
    name: 'AboutMe',
    description:
      'The AboutMe App is a web application crafted with HTML, CSS, and JavaScript. It serves as an introduction to Ahmeda Farhin, sharing information about the developer. The app presents a series of messages and images that illuminate Ahmeda\'s skills, background, hobbies, and passions. Users can cycle through different messages and corresponding images by clicking the "Click Again" button. This app offers a straightforward and interactive means to get acquainted with the developer, Ahmeda Farhin.',
    image: AboutMeImage,
  ...
  },
  {
    name: 'JIRA',
    description:
      'The Jira App is a web-based project management application developed using JavaScript, HTML, and CSS. Inspired by Jira, it enables users to create, manage, and collaborate on projects and tasks. Customize task states, labels, and priority levels to suit your project needs. Enjoy real-time updates for tracking task progress and changes as they occur. Simply log in, create a project, and start efficiently managing tasks with your team. Please note that this is a simplified version of Jira, providing essential project management functionality.',
    image: JIRAImage,
